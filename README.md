...
### 🤖 Smart Credit Builder — Live FinTech Platform
A full-stack credit-building platform deployed on AWS.
- **Spring Boot** backend with a **credit-scoring engine** and JWT-secured REST APIs
- **PostgreSQL on AWS RDS** for persistent, relational data
- **React + TypeScript (Vite)** frontend
- Focus on secure authentication, data integrity, and clean layered architecture
...
### 🗂️ TechTrackers
A full-stack tracking application (**ASP.NET Web API + React**), applying the same
production patterns: layered architecture, REST APIs, and secure auth.

---

## 💼 Experience

**Software Engineering Intern** — *Data Science Academy* · Aug 2025 – Present
Building production backend services with Java & Spring Boot using layered architecture. Designing RESTful APIs, implementing JWT authentication and RBAC, architecting PostgreSQL schemas, and containerising deployments with Docker.

**Software Developer Trainee** — *mLab Southern Africa (CodeTribe)* · Jun 2025 – Aug 2025
Developed React.js web features integrated with backend APIs. Collaborated in Agile sprints and implemented structured frontend-to-backend data exchange.

**Backend Developer Intern (WIL)** — *ICEP* · Jul 2024 – Jul 2025
...
**Advanced Diploma in Computer Science (NQF 7)** — *Tshwane University of Technology*
Expected June 2026 · Software architecture, systems design, and enterprise application development.

**Diploma in Computer Science (NQF 6)** — *Tshwane University of Technology*
Completed 2024 · OOP, databases, operating systems, information security, and web development.
